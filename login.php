			...
			<div class="col_2">
				...
				<div class="loginbox">
					...
					<form method="post" action="login_details.php">
						...
						<button type="submit" id="login-btn" name="login-btn" value="Login">Login</button>
						<button type="button" data-toggle="modal" data-target="#myModal" id="signup-btn" name="signup-btn" value="Signup">Signup</button>
